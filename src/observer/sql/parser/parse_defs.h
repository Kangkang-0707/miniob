...
struct ConditionSqlNode
{
  ...
  int            left_is_sub_query = 0;  ///< TRUE if left-hand side is a sub query
  Value          left_value;             ///< left-hand side value if left_is_attr = FALSE
  RelAttrSqlNode left_attr;              ///< left-hand side attribute
  shared_ptr<ParsedSqlNode> left_sub_query;  ///< left-hand side sub query if left_is_sub_query = TRUE
